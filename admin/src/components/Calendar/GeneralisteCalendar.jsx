...
function Main() {
  ...
  const { data: apiData, loading, error } = useFetchData(auth.user.role === "admin"?"appointment/admin" : "appointment/superAdmin", [successSubmit],true, true);
  console.log("eeeeeeeeee",apiData)  
...
const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiService.post("appointment/admin", dataToSend, true, false);

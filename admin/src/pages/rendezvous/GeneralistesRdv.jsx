import AppointmentsCalendar from "../Calendar/AppointmentsCalendar.jsx";
...
function GeneralistesRdv() {
  ...
  const {data, loading, error} = useFetchData(auth.user.role === "admin"?"appointment/admin" : "appointment/superAdmin", [],true)
...
export default GeneralistesRdv